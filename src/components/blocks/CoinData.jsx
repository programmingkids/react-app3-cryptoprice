  ...
  return (
    <Container sx={{my:2}}>
      <Paper sx={{p:2, my:2}} elevation={2}>
        ...
        <Stack direction="row" spacing={2} alignItems="center">
          <Typography variant="coinPrice">&yen;{current_price.toLocaleString()}</Typography>
          <Typography
      ...
      <Paper sx={{p:2, my:2}} elevation={2}>
        <Stack direction="row" spacing={2} my={1} py={1} justifyContent="space-between" sx={{borderBottom: '1px solid #cecece'}}>
          <Typography
            variant="subtitle2"
          >
            24時間最高
